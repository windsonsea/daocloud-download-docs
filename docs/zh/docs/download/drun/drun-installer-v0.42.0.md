...
| 模块 | 介绍 | 最新动态 |
| ---- | --- | ------ |
| ClawOS | 多智能体运行和治理平台 | [v0.3.0](../../drun/clawos/workspace/index.md) |
| 大模型服务平台 | 提供从模型部署到运维管理的全生命周期服务，帮助企业和开发者高效地接入和使用各类大模型能力 | [v0.16.0](../../insight/intro/release-notes.md#v0163) |
...
| 云原生存储 | 提供统一数据存储服务，支持文件、对象、块、本地存储，轻松接入存储厂商方案 | [v1.0.2](../../storage/hwameistor/release-notes.md#v111) |
| 全局管理 | 负责用户访问控制、权限、工作空间与层级、审计日志、个性化外观设置等 | [v0.48.0](../../ghippo/intro/release-notes.md#v0492) |
| 可观测性 | 提供丰富的仪表盘、场景监控、数据查询、告警等图文信息 | [v0.42.2](../../insight/intro/release-notes.md#v0441) |
