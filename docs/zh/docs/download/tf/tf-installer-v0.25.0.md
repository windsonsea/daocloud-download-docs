...
| 微服务引擎 | 提供注册发现、服务治理、配置管理、微服务网关等治理能力 | [v0.43.4](../../skoala/intro/release-notes.md#v0434) |
...
| 中间件 Redis | 一款内存数据库缓存服务 | [v0.25.0](../../middleware/redis/release-notes.md#v0250) |
| 镜像仓库 | 用于存储 K8s、DevOps 和容器应用开发的镜像 | [v0.24.0](../../kangaroo/intro/release-notes.md#v0240) |
| 网络 | 针对不同的 Linux 内核，支持多种 CNI 组合方案 | [v0.16.2](../../network/intro/release-notes.md#0162) |
