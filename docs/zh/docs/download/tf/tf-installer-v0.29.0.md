...
| AI Lab | 整合异构算力，优化 GPU 性能，实现算力资源统一调度和运营 | [v0.16.1](../../baize/intro/release-notes.md#v0161) |
| 云边协同 | 将云原生能力延伸至边缘，采用边缘节点模式，将数据处理、业务应用、AI模型等下沉到边缘端执行 | [v0.19.1](../../kant/intro/release-notes.md#v0191) |
