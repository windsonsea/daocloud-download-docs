...
| ------- | --- | ---- | ------ | --- | ------- |
| offline-v0.42.0-amd64.tar | v0.42.0 | AMD 64 | 35.57GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.42.0-amd64.tar) | 2026-07-07 |
| offline-v0.42.0-arm64.tar | v0.42.0 | <font color="green">ARM 64</font> | 31.52GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.42.0-arm64.tar) | 2026-07-07 |
...
=== "AMD 64"
    ...
    ```sh
    tar -zxvf offline-v0.42.0-amd64.tar
    ```
