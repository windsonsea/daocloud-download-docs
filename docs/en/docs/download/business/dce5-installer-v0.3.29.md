...
# DCE Enterprise with Installer v0.3.29

This page allows you to download the offline package and checksum file of DCE Enterprise.
...
| offline-kylin-v10sp2-v0.3.29-arm64.tar | v0.3.29 | <font color="green">ARM 64</font> | 19.9 GB | [:arrow_down: Download](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-kylin-v10sp2-v0.3.29-arm64.tar) | 2022-12-16 |
...
| Middleware Elasticsearch | A popular full-text search engine | [v0.3](../../middleware/elasticsearch/release-notes.md#v032) |
| Middleware Kafka | Distributed message queue service based on open source software Kafka | [v0.1](../../middleware/kafka/release-notes.md#v0100) |
| Middleware MinIO | A very popular lightweight, open source object storage solution | [v0.1](../../middleware/minio/release-notes.md#v0100) |
