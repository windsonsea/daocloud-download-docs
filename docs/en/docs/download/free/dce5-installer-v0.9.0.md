...
This page allows you to download the offline package and checksum files for DCE Community.
...
- For installation instructions, refer to [DCE Community Installation Process](../../install/community/k8s/online.md#_2).
