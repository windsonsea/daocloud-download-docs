...
| {{armGpu.fileName}} | {{version}} | <font color="green">ARM 64</font> | {{armGpu.size}} | [:arrow_down: Download]({{armGpu.downloadLink}}) | {{date}} |
| {{amdMetax.fileName}} | {{version}} | AMD 64 | {{amdMetax.size}} | [:arrow_down: Download]({{amdMetax.downloadLink}}) | {{date}} |
...
DCE supports offline addons. After downloading the offline package, open clusterConfig.yaml,
