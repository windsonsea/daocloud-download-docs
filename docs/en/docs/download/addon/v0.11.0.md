...
DCE supports offline Addons. After downloading the offline package, open the clusterConfig.yaml file and modify the `addonOfflinePackagePath` field to specify the location of the Addon.
